    ...
    <ScrollView contentContainerStyle={{ padding: 14 }}>
      ...
      <View style={styles.metricGrid}>
        ...
        <View style={styles.metricCard}>
          ...
          <Text style={styles.metricValue}>{data?.qualified || 0}</Text>
        </View>

        <View style={styles.metricCard}>
          <Text style={styles.metricLabel}>Contacted</Text>
          <Text style={styles.metricValue}>{data?.contacted || 0}</Text>
        </View>

        <View style={styles.metricCard}>
          <Text style={styles.metricLabel}>New Leads</Text>
          <Text style={styles.metricValue}>{data?.new_leads || 0}</Text>
        </View>

        <View style={styles.metricCard}>
          <Text style={styles.metricLabel}>Follow Ups</Text>
          <Text style={styles.metricValue}>{data?.followups_done || 0}</Text>
        </View>

        <View style={styles.metricCard}>
          <Text style={styles.metricLabel}>Emails Sent</Text>
          <Text style={styles.metricValue}>{data?.emails_sent || 0}</Text>
        </View>
      </View>
    </ScrollView>
  );
